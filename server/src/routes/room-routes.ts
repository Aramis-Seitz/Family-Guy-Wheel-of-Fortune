...
import { handleCreateRoom, handleJoinRoom, handleLeaveRoom, handleCloseRoom, handleSpinRoom, handleResetRoom, handleSetMultiplier, handleUpdateWheelItems } from "../controllers/room-controller";
...
roomRoutes.post("/wheel-items", handleUpdateWheelItems);